    ...
    <div className={style.footer}>
      <div className={style.contactUs__footer}>
        ...
        <div className={style.contact__item}>
          ...
          <p className={style.contact__item__desc}>needhelp@iuca.kg</p>
        </div>
        <div className={style.contact__item}>
          <h4 className={style.contact__item__title}>Phone:</h4>
          <p className={style.contact__item__desc}>0558 777 011</p>
        </div>
        <div className={style.contact__item}>
          <h4 className={style.contact__item__title}>Address:</h4>
          <p className={style.contact__item__desc}>Tabyshalieva, 29</p>
        </div>
      </div>
      ...
      <div className={style.middle__footer}>
        <div className={style.middle__footer__title}>
          <img
            ...
            alt="error"
          />
          <h2 className={style.middle__footer__title__text}>Organick</h2>
        </div>
